...
function renderPage(
  ...
  // Both spellings of the override: a bare array of templates, or an object
  // carrying `types` alongside the other opt-ins. The array form is what the
  // older call sites use, so it is kept rather than rewriting one set.
