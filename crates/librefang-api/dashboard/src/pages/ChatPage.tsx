...
const MessageBubble = memo(function MessageBubble({ message, usageFooter, onCopy, copied, onSpeak, isSpeaking, ttsStatus, ttsAvailable, selected, onToggleSelected, agentId, agentName, agentAvatarUrl, agentEmoji }: MessageBubbleProps) {
  const { t } = useTranslation();
