...
import { Search, Users, MessageCircle, X, Cpu, Wrench, Shield, Plus, Loader2, Pause, Play, Clock, Brain, Zap, FlaskConical, Trash2, Copy, RotateCcw, Pencil, Bot, Database, FileText, MoreHorizontal, Sparkles, ChevronDown, ChevronRight, Check, Save, Library, GitBranch, Radio, History, Route } from "lucide-react";
...
export function AgentsPage() {
  ...
  const [agentTab, setAgentTab] = useState<
    "conversation" | "memory" | "skills" | "tools" | "schedule" | "logs" | "history" | "routing"
  >("conversation");
