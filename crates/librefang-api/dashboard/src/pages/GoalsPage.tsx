...
import { Shield, Trash2, Edit2, Plus, Target, Rocket, Bot, Database, Users, AlertTriangle, Loader2, CheckCircle2, Clock, Play, Square, ChevronDown, ChevronRight, Zap, Ban, Pause } from "lucide-react";
  ...
  if (isRunning && run) {
    return (
      <div className="flex items-center gap-0.5">
        {run && <GoalRunPhaseBadge phase={run.phase} iteration={run.iteration} maxIterations={run.max_iterations} />}
        <button
          type="button"
