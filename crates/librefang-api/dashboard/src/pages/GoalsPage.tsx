...
export function GoalsPage() {
  ...
  // Upstream extracted this loop to the module-level `runSequentialBatch`
  // during the same window; the local copy was byte-identical, so the alias
  // keeps every call site below unchanged with one implementation behind it.
