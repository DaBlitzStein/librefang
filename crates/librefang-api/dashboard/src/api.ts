...
export interface WorkflowStepResult {
   ...
   * emits them from `StepResult::variables`.
   *
   * Optional because a run recorded before the field existed has no snapshot;
   * every current construction site populates it.
   */
