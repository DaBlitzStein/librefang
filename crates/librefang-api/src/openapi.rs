...
#[openapi(
    ...
    paths(
        ...
        routes::get_agent_type_toml,
        routes::create_agent_type,
        routes::update_agent_type,
        routes::delete_agent_type,
        // Deprecated `/api/templates` aliases (kept working; flagged
        // `deprecated = true` in the generated spec).
        routes::list_agent_types_deprecated,
        routes::get_agent_type_deprecated,
        routes::get_agent_type_toml_deprecated,
        routes::create_agent_type_deprecated,
        routes::update_agent_type_deprecated,
        routes::delete_agent_type_deprecated,
