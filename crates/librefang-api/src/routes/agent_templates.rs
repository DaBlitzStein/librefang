...
// Re-exported under the agent-type spelling because the cloning and lifecycle
// routes were written against `agent_templates::validate_agent_type_name`;
// `/templates` and `/agent-types` are the same concept under two spellings.
pub(crate) use librefang_types::agent_type_store::validate_agent_type_name;
...
pub(crate) use librefang_types::agent_type_store::{
