...
pub fn purge_agent(
    ...
    // Reject path-shaped names before any of them reach `Path::join` below.
...
mod tests {
    ...
    fn it_leaves_every_other_agent_alone() {
        ...
        // The blast radius is exactly one agent.
        assert!(home
            .path()
    ...
    fn a_path_shaped_name_never_reaches_the_filesystem() {
        ...
        // Nothing was collaterally deleted while rejecting them.
        assert!(home.path().join("workspaces/agents/alpha").exists());
    }
}
