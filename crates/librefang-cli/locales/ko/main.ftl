...
agent-set-unknown-field = 알 수 없는 필드: { $field }. 지원되는 필드: model, temperature, max_tokens, top_p, frequency_penalty, presence_penalty, top_k, min_p, repeat_penalty, context_window, max_output_tokens
...
tui-event-dashboard-status-fetch-failed = 데몬 상태를 불러오지 못했습니다
tui-event-dashboard-audit-fetch-failed = 최근 활동을 불러오지 못했습니다
tui-event-workflows-fetch-failed = 워크플로를 불러오지 못했습니다
tui-event-triggers-fetch-failed = 트리거를 불러오지 못했습니다
tui-event-sessions-fetch-failed = 세션을 불러오지 못했습니다
tui-event-agents-fetch-failed = 에이전트를 불러오지 못했습니다
tui-event-kv-fetch-failed = 에이전트 { $agent_id }의 메모리를 불러오지 못했습니다
tui-event-clawhub-search-failed = ClawHub 검색에 실패했습니다
tui-event-clawhub-browse-failed = ClawHub를 탐색하지 못했습니다
tui-event-templates-fetch-failed = 에이전트 템플릿을 불러오지 못했습니다
tui-event-providers-fetch-failed = 프로바이더를 불러오지 못했습니다
tui-event-security-fetch-failed = 보안 상태를 불러오지 못했습니다
tui-event-audit-fetch-failed = 감사 기록을 불러오지 못했습니다
tui-event-usage-summary-fetch-failed = 사용량 요약을 불러오지 못했습니다
tui-event-usage-by-model-fetch-failed = 모델별 사용량을 불러오지 못했습니다
tui-event-usage-by-agent-fetch-failed = 에이전트별 사용량을 불러오지 못했습니다
tui-event-tools-fetch-failed = 도구를 불러오지 못했습니다
tui-event-groups-fetch-failed = 그룹을 불러오지 못했습니다
tui-event-peers-fetch-failed = 피어를 불러오지 못했습니다
tui-event-logs-fetch-failed = 로그를 불러오지 못했습니다
tui-event-goals-fetch-failed = 목표를 불러오지 못했습니다
tui-event-hands-fetch-failed = 핸드를 불러오지 못했습니다
tui-event-active-hands-fetch-failed = 활성 핸드를 불러오지 못했습니다
tui-event-extensions-fetch-failed = 확장을 불러오지 못했습니다
tui-event-extension-health-fetch-failed = 확장 상태를 불러오지 못했습니다
tui-event-comms-topology-fetch-failed = 에이전트 토폴로지를 불러오지 못했습니다
tui-event-comms-events-fetch-failed = 통신 이벤트를 불러오지 못했습니다
tui-event-agent-model-label-fetch-failed = 에이전트 { $agent_id }의 모델을 불러오지 못했습니다
...
tui-mod-vault-key-saved = { $key }을(를) 저장했습니다
tui-mod-vault-key-deleted = { $key }을(를) 삭제했습니다
tui-mod-vault-key-saved-env-override = { $key }을(를) 저장했지만 데몬이 자체 환경 변수에서 읽으므로 저장된 값은 사용되지 않습니다
tui-mod-vault-key-deleted-env-override = 볼트에서 { $key }을(를) 삭제했지만 데몬이 여전히 자체 환경 변수에서 읽으므로 실제로 취소된 것은 없습니다
...
tui-templates-hints =   [↑↓] 탐색  [Enter] 에이전트 생성  [f] 카테고리 필터  [r] 새로고침  [R] 복원  [v] 버전 기록
...
tui-templates-restore-invalid-name = 잘못된 템플릿 이름입니다
...
tui-templates-restore-failed = 레지스트리에서 복원하지 못했습니다
tui-templates-history-failed = 버전 기록을 불러오지 못했습니다
tui-templates-history-loading = { $name }의 버전 기록을 불러오는 중…
tui-templates-history-daemon-only = 버전 기록은 데몬 모드가 필요합니다
tui-templates-history-title = { $name }의 버전 기록
tui-templates-history-col-id = 버전 ID
tui-templates-history-col-created = 생성일
tui-templates-history-col-source = 출처
tui-templates-history-error = 버전 기록을 불러올 수 없습니다: { $detail }
tui-templates-history-shape = 데몬의 버전 기록 응답의 형식이 예상과 다릅니다
tui-templates-history-empty = 사용 가능한 버전 기록이 없습니다
tui-templates-history-manifest-only = 버전 기록은 사용자 정의 템플릿에만 사용할 수 있습니다
tui-templates-version-restoring = { $name }을(를) 선택한 버전으로 복원하는 중…
tui-templates-version-restore-failed = 버전을 복원하지 못했습니다
tui-templates-history-hints = [Esc] 뒤로  [↑↓] 탐색  [Enter] 복원
...
tui-settings-tab-vault = 7 볼트
tui-settings-hints-vault =   [↑↓] 이동  [e] 값 설정  [d] 지우기  [r] 새로 고침
tui-settings-vault-header-key = 키
tui-settings-vault-header-status = 상태
tui-settings-vault-loading = 볼트 키를 불러오는 중...
tui-settings-vault-empty = 이 데몬에는 쓰기 가능한 볼트 키가 없습니다
tui-settings-vault-status-set = 설정됨
tui-settings-vault-status-notset = 설정 안 됨
tui-settings-vault-status-env = 환경 변수가 우선함
tui-settings-vault-input-prompt = { $key }의 새 값을 입력하세요
tui-settings-vault-note = 저장된 값은 다시 표시되지 않습니다. [e] 교체, [d] 삭제.
tui-settings-vault-note-env-override = { $keys }은(는) 데몬 자체 환경 변수에서 오며 볼트보다 우선합니다. [e]와 [d]는 저장된 사본만 바꾸며 데몬이 사용하는 자격 증명은 바꾸지 않습니다.
tui-settings-vault-delete-confirm =   이 볼트 키를 지우시겠습니까? [y] 예  [any] 취소
...
tui-agents-workspaces-help = a 추가 · d 삭제 · Enter 편집 · Tab/Shift+Tab 필드 · s 저장 · Esc 뒤로
...
tui-event-workspaces-not-available-in-process = 공유 폴더 편집에는 실행 중인 데몬이 필요합니다.
...
tui-workflows-hints-runs =   [↑↓] 탐색  [a] 자동 새로고침  [r] 새로고침  [Esc] 뒤로
...
tui-workflows-hint-steps = 에이전트 소스는 값이 무엇을 가리키는지 정합니다: 실행 중인 에이전트의 ID, 에이전트 이름, 또는 에이전트 타입입니다. 에이전트 타입은 템플릿 이름이며 해당 타입이 실행 중이 아니면 새로 생성됩니다. 세션을 "실행마다 새로"로 두면 매 실행마다 새 세션을 사용합니다.
tui-workflows-label-steps = 단계:
tui-workflows-steps-empty = 아직 단계가 없습니다. [a]를 눌러 추가하세요.
tui-workflows-step-field-name = 단계 이름
tui-workflows-step-field-source = 에이전트 소스
tui-workflows-step-field-prompt = 프롬프트
tui-workflows-step-field-session = 세션
tui-workflows-source-id = 에이전트 ID
tui-workflows-source-name = 에이전트 이름
tui-workflows-source-type = 에이전트 타입
tui-workflows-session-persistent = 유지
tui-workflows-session-new = 실행마다 새로
tui-workflows-placeholder-agent-id = 실행 중인 에이전트의 UUID
tui-workflows-placeholder-agent-name = 기존 에이전트의 이름
tui-workflows-placeholder-agent-type = 템플릿 이름 (실행 중인 것이 없으면 생성)
tui-workflows-placeholder-prompt = 이 단계가 요청할 내용; {"{{input}}"}은 워크플로 입력
tui-workflows-steps-none = [a]로 단계를 하나 이상 추가하세요.
tui-workflows-step-agent-required = { $step }단계: { $source }은(는) 필수입니다
tui-workflows-step-prompt-required = { $step }단계: 프롬프트는 필수입니다
tui-workflows-label-review = 검토 — Enter를 눌러 생성
tui-workflows-review-name =   이름:  
tui-workflows-review-desc =   설명:  
tui-workflows-review-steps =   단계:  
tui-workflows-hints-create-submit =   [Enter] 생성  [Esc] 뒤로
tui-workflows-hints-create-next =   [Enter] 다음  [Esc] 뒤로
tui-workflows-hints-create-steps-list =   [a] 추가  [d] 삭제  [↑↓] 단계 선택  [Tab] 필드  [Enter] 다음  [Esc] 뒤로
tui-workflows-hints-create-steps-text =   [Tab/Shift-Tab] 필드  [↑↓] 단계 선택  [Enter] 다음  [Esc] 뒤로
tui-workflows-hints-create-steps-select =   [Space/←→] 변경  [Tab/Shift-Tab] 필드  [↑↓] 단계 선택  [Enter] 다음  [Esc] 뒤로
...
tui-agents-param-top-k-hint = top_k — 가장 가능성 높은 K개 토큰만 고려합니다. Anthropic, Gemini, Ollama, OpenRouter, 로컬 서버 전용.
tui-agents-param-min-p = 최소 확률
tui-agents-param-min-p-hint = min_p — 최상위 토큰보다 훨씬 가능성이 낮은 토큰을 제외합니다. Ollama, vLLM, llama.cpp, OpenRouter 전용.
tui-agents-param-repeat-penalty = 반복 페널티
tui-agents-param-repeat-penalty-hint = repeat_penalty — 최근 반복된 토큰을 억제합니다. 1.0은 끔. Ollama, OpenRouter 및 로컬 서버 전용.
...
tui-agents-label-routing-stable-inert = 커널이 안정 모드로 실행 중입니다. 라우터가 실행되지 않으며 이 에이전트는 { $model }을(를) 사용합니다. 여기에서 저장한 설정은 커널이 안정 모드를 벗어나면 적용됩니다.
tui-agents-label-routing-stable-inert-manifest = 커널이 안정 모드로 실행 중입니다. 라우터가 실행되지 않으며 이 에이전트는 매니페스트의 모델을 사용합니다. 여기에서 저장한 설정은 커널이 안정 모드를 벗어나면 적용됩니다.
...
tui-goals-label-loop-engineering = 루프 엔지니어링:
tui-goals-label-verifier = 검증 에이전트:
tui-goals-label-evaluator = 평가 모델:
tui-goals-label-verify-rounds = 검증 라운드:
tui-goals-loop-engineering-on = 사용함
tui-goals-loop-engineering-off = 사용 안 함
tui-goals-verifier-none = 없음
tui-goals-evaluator-none = 없음, 에이전트 자신의 표시로 결정합니다
tui-goals-hint-stop = [s] 실행 중지
tui-goals-hint-start = [s] 실행 시작
tui-goals-hint-rounds = [+/-] 라운드 (verify_max_retries)
tui-goals-detail-hints = [q/Esc] 닫기 { $run_hint } [r] 새로고침
tui-goals-verify-rounds-default = 기본값
tui-goals-verify-rounds-next = { $current } (다음: { $next })
...
tui-goals-loop-engineering-hint = 에이전트가 스스로 완료를 선언하는 대신, 매 반복마다 두 번째 에이전트의 판정을 거치게 합니다. 끄면 일반 목표 루프와 완전히 동일합니다. [space] 전환, [y]/[n] 직접 지정. 필드: loop_engineering.
tui-goals-verifier-hint = 결과물을 평가할 에이전트의 UUID. 비워 두면 검증 관문이 없습니다. 에이전트는 자기 작업을 스스로 평가하지 않습니다. 필드: verify_agent_id.
tui-goals-evaluator-hint = 에이전트의 GOAL_DONE 표시와 무관하게 목표 달성 여부를 판단하는 모델. 작고 저렴한 모델이 적합합니다. 비워 두면 표시만 사용합니다. 필드: evaluator_model.
tui-goals-nav-next = [Enter] 다음  [Esc] 뒤로
tui-goals-nav-submit = [Enter] 만들기  [Esc] 뒤로
tui-goals-create-incomplete = 제목과 에이전트가 모두 필요합니다.
tui-goals-label-tick = 반복 간격:
tui-goals-tick-hint = 러너가 루프 반복 사이에 대기하는 시간(초)입니다(tick_interval_secs). 비워 두면 기본값 { $default }을(를) 사용합니다. 허용 범위는 { $min }–{ $max }입니다.
tui-goals-tick-value = { $secs }초
tui-goals-tick-default = { $secs }초(기본값)
tui-goals-tick-out-of-range = 반복 간격은 { $min }초에서 { $max }초 사이여야 합니다.
...
agent-routing-label-stable = 안정 모드
agent-routing-stable-inert = 라우터가 실행되지 않습니다. 커널이 안정 모드를 벗어날 때까지 이 에이전트는 { $model }을(를) 사용합니다
agent-routing-stable-inert-manifest = 라우터가 실행되지 않습니다. 커널이 안정 모드를 벗어날 때까지 이 에이전트는 매니페스트의 모델을 사용합니다
