...
model-overrides-save-failed = Failed to save overrides for { $model } (status { $status })
model-overrides-cleared = Overrides cleared for { $model }
model-overrides-clear-failed = Failed to clear overrides for { $model } (status { $status })
...
chat-runner-goal-no-agent = No agent selected.
...
chat-runner-no-agent-templates = No agent types found. Run `librefang init`.
chat-runner-invalid-template = Invalid agent type '{ $name }': { $error }
...
tui-event-model-routing-update-error = Model routing update: { $error }
...
tui-event-model-overrides-fetch-failed = Failed to load overrides for { $model }
tui-event-model-overrides-save-failed = Failed to save overrides for { $model }
tui-event-model-overrides-reset-failed = Failed to reset overrides for { $model }
...
tui-mod-model-overrides-saved = Overrides saved for { $model }
tui-mod-model-overrides-reset = Overrides reset for { $model }
...
tui-settings-hints-models =   [↑↓] Navigate  [e] Edit Window  [x] Reset  [r] Refresh
tui-settings-hints-models-edit =   [Tab] Field  [Enter] Save  [Esc] Cancel
...
tui-settings-tab-backups = 5 Backups
tui-settings-tab-capabilities = 4 Capabilities
tui-settings-hints-capabilities =   [↑↓] Navigate  [Enter] Edit  [r] Refresh
tui-settings-hints-capabilities-edit =   Type provider/model  [Enter] Save  [Esc] Cancel  (empty = auto-detect)
tui-settings-capabilities-header-capability = Capability
tui-settings-capabilities-header-target = Provider / Model
tui-settings-capabilities-auto = auto-detect
tui-settings-capabilities-explainer = Global default for every agent; an agent's own [capabilities] overrides it.
tui-settings-capability-image-understanding = Vision
tui-settings-capability-speech-to-text = Transcription
tui-settings-capability-image-generation = Image generation
tui-settings-capability-text-to-speech = Speech generation
tui-settings-capability-video-generation = Video generation
tui-settings-capability-music-generation = Music generation
tui-event-capabilities-fetch-failed = Failed to load capability routing
tui-event-capabilities-save-failed = Failed to save routing for { $capability }
tui-mod-capability-routing-saved = Routing saved for { $capability }
tui-settings-backup-keep-config = Keep my config (clone mode)
tui-settings-backup-empty = No backups yet. Press c to create one.
tui-settings-hints-backups = c create · r restore · d delete · space keep-config · 1-8 components
...
tui-settings-models-edit-title = Model Overrides
tui-settings-models-edit-context-window = Context Window
tui-settings-models-edit-max-output = Max Output Tokens
tui-settings-models-edit-empty-hint =   Leave a field empty to clear that override and fall back to the catalog value.
...
tui-agents-detail-owner = { "  " }Owner:{ "    " }
tui-agents-detail-owner-unowned = unowned
tui-agents-detail-author = { "  " }Author:{ "   " }
...
tui-memory-config-unsaved = Unsaved changes — press s to save
tui-memory-config-saving = Saving...
tui-memory-config-saved = Saved
tui-memory-config-save-failed = Could not save
tui-memory-config-loading = Reading configuration...
tui-memory-config-hint =  ↑↓ move · space change · s save · r refresh · Esc back
...
tui-goal-run-paused = Run paused for goal: { $id }
tui-goal-run-resumed = Run resumed for goal: { $id }
tui-goal-cadence-updated = Cadence updated for goal: { $id }
...
tui-goal-pause-failed = Failed to pause goal run
tui-goal-resume-failed = Failed to resume goal run
tui-goal-cadence-failed = Failed to update the goal cadence
...
tui-goals-hints = { "  " }/ search | n new | s start | p pause | x stop | c cadence | d delete | Enter detail | r refresh
...
tui-goals-hint-running = p pause | x stop
tui-goals-hint-paused = s resume | x stop
tui-goals-detail-hints = { "  " }q/Esc close | { $run_hint } | c cadence | r refresh
tui-goals-run-running = Running
tui-goals-run-paused = Paused
tui-goals-run-finished = Finished
tui-goals-run-maxiter = Max iterations reached
tui-goals-run-ratelimited = Rate limited
tui-goals-run-stopped = Stopped
tui-goals-resume-from = { "  " }Resumes from iteration { $iteration } of { $max }
tui-goals-resume-from-simple = { "  " }Resumes from iteration { $iteration }
tui-goals-pause-explainer = Pausing keeps this progress; stopping discards it.
tui-goals-already-running = This goal is already running — p pauses it, x stops it.
tui-goals-already-paused = This goal is already paused — s resumes it, x discards it.
tui-goals-not-running = Only a running goal can be paused.
tui-goals-nothing-to-stop = This goal has no run to stop.
tui-goals-cadence = Cadence:
tui-goals-cadence-label = { "  " }Cadence:{ " " }
tui-goals-cadence-title = Loop cadence
tui-goals-cadence-hint = How often the agent takes another turn, in seconds. Leave blank for the default of { $default }s. A low cadence spends tokens faster; the most you can ask for is { $max }s.
tui-goals-cadence-secs = { $secs }s
tui-goals-cadence-default = default ({ $secs }s)
tui-goals-cadence-nav = Esc cancel | Enter save
tui-goals-cadence-not-a-number = Enter a whole number of seconds, or leave it blank for the default.
tui-goals-cadence-out-of-range = The cadence must be between { $min } and { $max } seconds.
