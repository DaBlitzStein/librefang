...
section-active-agents = Активні агенти
section-persisted-agents = Збережені агенти
...
# --- Doctor ---
doctor-title = Діагностика LibreFang
...
config-no-file-fix = Спочатку виконайте `librefang init`
...
agent-set-unknown-field = Невідоме поле: { $field }. Підтримувані поля: model, temperature, max_tokens, top_p, frequency_penalty, presence_penalty, top_k, min_p, repeat_penalty, context_window, max_output_tokens
...
tui-event-dashboard-status-fetch-failed = Не вдалося завантажити стан демона
tui-event-dashboard-audit-fetch-failed = Не вдалося завантажити останню активність
tui-event-workflows-fetch-failed = Не вдалося завантажити робочі процеси
tui-event-triggers-fetch-failed = Не вдалося завантажити тригери
tui-event-sessions-fetch-failed = Не вдалося завантажити сесії
tui-event-agents-fetch-failed = Не вдалося завантажити агентів
tui-event-kv-fetch-failed = Не вдалося завантажити пам'ять агента { $agent_id }
tui-event-clawhub-search-failed = Пошук у ClawHub не вдався
tui-event-clawhub-browse-failed = Не вдалося переглянути ClawHub
tui-event-templates-fetch-failed = Не вдалося завантажити шаблони агентів
tui-event-providers-fetch-failed = Не вдалося завантажити провайдерів
tui-event-security-fetch-failed = Не вдалося завантажити стан безпеки
tui-event-audit-fetch-failed = Не вдалося завантажити журнал аудиту
tui-event-usage-summary-fetch-failed = Не вдалося завантажити зведення використання
tui-event-usage-by-model-fetch-failed = Не вдалося завантажити використання за моделями
tui-event-usage-by-agent-fetch-failed = Не вдалося завантажити використання за агентами
tui-event-tools-fetch-failed = Не вдалося завантажити інструменти
tui-event-groups-fetch-failed = Не вдалося завантажити групи
tui-event-peers-fetch-failed = Не вдалося завантажити пірів
tui-event-logs-fetch-failed = Не вдалося завантажити журнали
tui-event-goals-fetch-failed = Не вдалося завантажити цілі
tui-event-hands-fetch-failed = Не вдалося завантажити Hands
tui-event-active-hands-fetch-failed = Не вдалося завантажити активні Hands
tui-event-extensions-fetch-failed = Не вдалося завантажити розширення
tui-event-extension-health-fetch-failed = Не вдалося завантажити стан розширень
tui-event-comms-topology-fetch-failed = Не вдалося завантажити топологію агентів
tui-event-comms-events-fetch-failed = Не вдалося завантажити події зв'язку
tui-event-agent-model-label-fetch-failed = Не вдалося завантажити модель агента { $agent_id }
...
tui-mod-vault-key-saved = { $key } збережено
tui-mod-vault-key-deleted = { $key } очищено
tui-mod-vault-key-saved-env-override = { $key } збережено, але демон читає його зі свого середовища — збережене значення не використовується
tui-mod-vault-key-deleted-env-override = { $key } очищено зі сховища, але демон і далі читає його зі свого середовища — нічого не відкликано
...
tui-tab-hands = Hands
tui-tab-extensions = Розш
tui-tab-templates = Шабл
tui-tab-peers = Піри
tui-tab-comms = Зв'язок
tui-tab-security = Безп
tui-tab-audit = Аудит
...
tui-templates-hints =   [↑↓] Навігація  [Enter] Запустити Агента  [f] Фільтр категорій  [r] Оновити  [R] Відновити  [v] Історія версій
...
tui-templates-restore-invalid-name = Недійсна назва шаблону
...
tui-templates-restore-failed = Не вдалося відновити з реєстру
tui-templates-history-failed = Не вдалося завантажити історію версій
tui-templates-history-loading = Завантаження історії версій для { $name }…
tui-templates-history-daemon-only = Історія версій потребує режиму демона
tui-templates-history-title = Історія версій для { $name }
tui-templates-history-col-id = ID версії
tui-templates-history-col-created = Створено
tui-templates-history-col-source = Джерело
tui-templates-history-error = Не вдалося завантажити історію версій: { $detail }
tui-templates-history-shape = Відповідь демона з історією версій має несподівану форму
tui-templates-history-empty = Історія версій недоступна
tui-templates-history-manifest-only = Історія версій доступна лише для власних шаблонів
tui-templates-version-restoring = Відновлення { $name } до вибраної версії…
tui-templates-version-restore-failed = Не вдалося відновити версію
tui-templates-history-hints = [Esc] Назад  [↑↓] Навігація  [Enter] Відновити
...
tui-settings-tab-vault = 7 Сховище
tui-settings-hints-vault =   [↑↓] Навігація  [e] Задати значення  [d] Очистити  [r] Оновити
tui-settings-vault-header-key = КЛЮЧ
tui-settings-vault-header-status = СТАН
tui-settings-vault-loading = Завантаження ключів сховища...
tui-settings-vault-empty = Цей демон не надає ключів сховища, доступних для запису
tui-settings-vault-status-set = Встановлено
tui-settings-vault-status-notset = Не встановлено
tui-settings-vault-status-env = Перевизначено середовищем
tui-settings-vault-input-prompt = Введіть нове значення для { $key }
tui-settings-vault-note = Збережені значення більше не показуються. [e] замінити, [d] очистити.
tui-settings-vault-note-env-override = { $keys } надходить із власного середовища демона, яке має перевагу над сховищем. [e] і [d] змінюють збережену копію, а не облікові дані, які використовує демон.
tui-settings-vault-delete-confirm =   Очистити цей ключ сховища? [y] Так  [будь-яка клавіша] Скасувати
...
tui-agents-workspaces-help = a додати · d видалити · Enter редагувати · Tab/Shift+Tab поле · s зберегти · Esc назад
...
tui-event-workspaces-not-available-in-process = Редагування спільних папок вимагає запущеного демона.
...
tui-workflows-header-run-id = ID запуску
...
tui-workflows-hints-runs =   [↑↓] Навігація  [a] Автооновлення  [r] Оновити  [Esc] Назад
...
tui-workflows-hint-steps = Джерело агента визначає, що означає значення: ID запущеного агента, ім'я агента або тип агента — назву шаблону, з якого агент запускається, коли жодного агента цього типу не працює. Сесія «Нова на кожен запуск» дає кроку нову сесію під час кожного запуску.
tui-workflows-label-steps = Кроки:
tui-workflows-steps-empty = Кроків ще немає. Натисніть [a], щоб додати.
tui-workflows-step-field-name = Назва кроку
tui-workflows-step-field-source = Джерело агента
tui-workflows-step-field-prompt = Промпт
tui-workflows-step-field-session = Сесія
tui-workflows-source-id = ID агента
tui-workflows-source-name = Ім'я агента
tui-workflows-source-type = Тип агента
tui-workflows-session-persistent = Постійна
tui-workflows-session-new = Нова на кожен запуск
tui-workflows-placeholder-agent-id = UUID запущеного агента
tui-workflows-placeholder-agent-name = ім'я наявного агента
tui-workflows-placeholder-agent-type = назва шаблону; запускається, якщо жоден не працює
tui-workflows-placeholder-prompt = що просить цей крок; {"{{input}}"} — вхідні дані воркфлоу
tui-workflows-steps-none = Додайте щонайменше один крок клавішею [a].
tui-workflows-step-agent-required = Крок { $step }: поле «{ $source }» є обов'язковим
tui-workflows-step-prompt-required = Крок { $step }: промпт є обов'язковим
...
tui-workflows-review-steps =   Кроки: 
tui-workflows-hints-create-submit =   [Enter] Створити  [Esc] Назад
tui-workflows-hints-create-next =   [Enter] Далі  [Esc] Назад
tui-workflows-hints-create-steps-list =   [a] Додати  [d] Видалити  [↑↓] Вибрати крок  [Tab] Поля  [Enter] Далі  [Esc] Назад
tui-workflows-hints-create-steps-text =   [Tab/Shift-Tab] Поля  [↑↓] Вибрати крок  [Enter] Далі  [Esc] Назад
tui-workflows-hints-create-steps-select =   [Space/←→] Змінити  [Tab/Shift-Tab] Поля  [↑↓] Вибрати крок  [Enter] Далі  [Esc] Назад
...
tui-triggers-label-agent-id = ID агента:
...
tui-agents-param-top-k-hint = top_k — враховувати лише K найімовірніших токенів. Лише Anthropic, Gemini, Ollama, OpenRouter і локальні сервери.
tui-agents-param-min-p = Мінімальна ймовірність
tui-agents-param-min-p-hint = min_p — відкидає токени, значно менш імовірні за найкращий. Лише Ollama, vLLM, llama.cpp і OpenRouter.
tui-agents-param-repeat-penalty = Штраф за повторення
tui-agents-param-repeat-penalty-hint = repeat_penalty — стримує нещодавно повторені токени; 1.0 вимикає. Лише Ollama, OpenRouter і локальні сервери.
...
purge-removed-avatar =   - зображення аватара
...
tui-goals-label-loop-engineering = Інженерія циклу:
tui-goals-label-verifier = Агент-перевіряч:
tui-goals-label-evaluator = Модель-оцінювач:
tui-goals-label-verify-rounds = Раунди перевірки:
tui-goals-loop-engineering-on = увімкнено
tui-goals-loop-engineering-off = вимкнено
tui-goals-verifier-none = немає
tui-goals-evaluator-none = немає, вирішує власна позначка агента
tui-goals-hint-stop = [s] спинити
tui-goals-hint-start = [s] почати
tui-goals-hint-rounds = [+/-] Раунди (verify_max_retries)
tui-goals-detail-hints = [q/Esc] Закрити { $run_hint } [r] Оновити
tui-goals-verify-rounds-default = за замовчуванням
tui-goals-verify-rounds-next = { $current } (далі: { $next })
...
tui-goals-loop-engineering-hint = Кожна ітерація проходить вердикт другого агента замість власної заяви агента про завершення. Вимкнено — це точно звичайний цикл цілі. [space] перемикає, [y]/[n] задають значення. Поле: loop_engineering.
tui-goals-verifier-hint = UUID агента, який оцінює роботу. Порожнє поле означає відсутність перевірки. Агент не оцінює власну роботу. Поле: verify_agent_id.
tui-goals-evaluator-hint = Модель, яка судить про досягнення цілі незалежно від позначки GOAL_DONE агента. Підійде невелика дешева модель. Порожнє поле — покладатися лише на позначку. Поле: evaluator_model.
...
tui-goals-label-tick = Інтервал ітерацій:
tui-goals-tick-hint = Скільки секунд раннер чекає між ітераціями циклу (tick_interval_secs). Залиште порожнім, щоб узяти типове значення { $default }. Допустимий діапазон { $min }–{ $max }.
tui-goals-tick-value = { $secs } с
tui-goals-tick-default = { $secs } с (типово)
tui-goals-tick-out-of-range = Інтервал ітерацій має бути від { $min } до { $max } секунд.
...
tui-agents-label-routing-stable-inert = Ядро працює в стабільному режимі: маршрутизатор не працює, і цей агент використовує { $model }. Налаштування, збережені тут, наберуть чинності, коли ядро вийде зі стабільного режиму.
tui-agents-label-routing-stable-inert-manifest = Ядро працює в стабільному режимі: маршрутизатор не працює, і цей агент використовує модель зі свого маніфесту. Налаштування, збережені тут, наберуть чинності, коли ядро вийде зі стабільного режиму.
...
agent-routing-label-stable = Стабільний режим
agent-routing-stable-inert = маршрутизатор не працює; цей агент використовує { $model }, доки ядро не вийде зі стабільного режиму
agent-routing-stable-inert-manifest = маршрутизатор не працює; цей агент використовує модель зі свого маніфесту, доки ядро не вийде зі стабільного режиму
