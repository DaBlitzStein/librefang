...
model-overrides-saved = Перевизначення збережено для { $model }
model-overrides-save-failed = Не вдалося зберегти перевизначення для { $model } (статус { $status })
model-overrides-cleared = Перевизначення скинуто для { $model }
model-overrides-clear-failed = Не вдалося скинути перевизначення для { $model } (статус { $status })
model-overrides-none-set = Для { $model } не встановлено жодного перевизначення.
...
chat-runner-goal-no-agent = Агента не вибрано.
...
chat-runner-no-agent-templates = Типів агентів не знайдено. Запустіть `librefang init`.
chat-runner-invalid-template = Некоректний тип агента '{ $name }': { $error }
...
tui-event-model-routing-update-error = Оновлення маршрутизації моделі: { $error }
...
tui-event-model-overrides-fetch-failed = Не вдалося завантажити перевизначення для { $model }
tui-event-model-overrides-save-failed = Не вдалося зберегти перевизначення для { $model }
tui-event-model-overrides-reset-failed = Не вдалося скинути перевизначення для { $model }
...
tui-mod-model-overrides-saved = Перевизначення збережено для { $model }
tui-mod-model-overrides-reset = Перевизначення скинуто для { $model }
...
tui-templates-header-template = Тип
...
tui-settings-hints-models =   [↑↓] Навігація  [e] Редагувати вікно  [x] Скинути  [r] Оновити
tui-settings-hints-models-edit =   [Tab] Поле  [Enter] Зберегти  [Esc] Скасувати
...
tui-settings-tab-backups = 5 Резервні копії
tui-settings-tab-capabilities = 4 Можливості
tui-settings-hints-capabilities =   [↑↓] Навігація  [Enter] Редагувати  [r] Оновити
tui-settings-hints-capabilities-edit =   Введіть провайдер/модель  [Enter] Зберегти  [Esc] Скасувати  (порожньо = автовизначення)
tui-settings-capabilities-header-capability = Можливість
tui-settings-capabilities-header-target = Провайдер / Модель
tui-settings-capabilities-auto = автовизначення
tui-settings-capabilities-explainer = Глобальне значення для всіх агентів; власний [capabilities] агента має вищий пріоритет.
tui-settings-capability-image-understanding = Зір
tui-settings-capability-speech-to-text = Транскрибування
tui-settings-capability-image-generation = Генерація зображень
tui-settings-capability-text-to-speech = Синтез мовлення
tui-settings-capability-video-generation = Генерація відео
tui-settings-capability-music-generation = Генерація музики
tui-event-capabilities-fetch-failed = Не вдалося завантажити маршрутизацію можливостей
tui-event-capabilities-save-failed = Не вдалося зберегти маршрутизацію для { $capability }
tui-mod-capability-routing-saved = Маршрутизацію збережено для { $capability }
tui-settings-backup-keep-config = Зберегти мою конфігурацію (режим клону)
tui-settings-backup-empty = Резервних копій ще немає. Натисніть c, щоб створити.
tui-settings-hints-backups = c створити · r відновити · d видалити · space зберегти конфіг · 1-8 компоненти
...
tui-settings-models-edit-title = Перевизначення моделі
tui-settings-models-edit-context-window = Вікно контексту
tui-settings-models-edit-max-output = Макс. вихідних токенів
tui-settings-models-edit-empty-hint =   Залиште поле порожнім, щоб очистити це перевизначення і повернутися до значення каталогу.
...
tui-agents-detail-owner = { "  " }Власник:{ "  " }
tui-agents-detail-owner-unowned = без власника
tui-agents-detail-author = { "  " }Автор:{ "    " }
...
tui-memory-config-unsaved = Незбережені зміни — натисніть s
tui-memory-config-saving = Збереження...
tui-memory-config-saved = Збережено
tui-memory-config-save-failed = Не вдалося зберегти
tui-memory-config-loading = Читання конфігурації...
tui-memory-config-hint =  ↑↓ рух · пробіл змінити · s зберегти · r оновити · Esc назад
...
tui-goal-run-started = Запуск для цілі: { $id }
tui-goal-run-stopped = Запуск зупинено для цілі: { $id }
tui-goal-run-paused = Запуск призупинено для цілі: { $id }
tui-goal-run-resumed = Запуск відновлено для цілі: { $id }
tui-goal-cadence-updated = Ритм оновлено для цілі: { $id }
...
tui-goal-start-failed = Не вдалося запустити ціль
tui-goal-start-error = Запуск цілі: { $error }
tui-goal-stop-failed = Не вдалося зупинити ціль
tui-goal-pause-failed = Не вдалося призупинити ціль
tui-goal-resume-failed = Не вдалося відновити ціль
tui-goal-cadence-failed = Не вдалося оновити ритм цілі

tui-agents-space-toggle =   (Пробіл для перемикання)
tui-agents-cost-budget =   Бюджет витрат: 
tui-agents-hl-change =   (h/l для зміни)
tui-agents-allowed-profiles =   Дозволені профілі (Tab для перемикання):
tui-agents-no-profiles =     (немає доступних профілів)

tui-goals-filter = { "  " }фільтр: { $query }
tui-goals-loading = Завантаження цілей...
tui-goals-empty = Цілей не знайдено.
tui-goals-hints = { "  " }/ пошук | n нова | s запуск | p пауза | x зупинити | c ритм | d видалити | Enter деталі | r оновити
...
tui-goals-hint-running = p пауза | x зупинити
tui-goals-hint-paused = s відновити | x зупинити
tui-goals-detail-hints = { "  " }q/Esc закрити | { $run_hint } | c ритм | r оновити
tui-goals-run-running = Виконується
tui-goals-run-paused = На паузі
tui-goals-run-finished = Завершено
tui-goals-run-maxiter = Досягнуто ліміт ітерацій
tui-goals-run-ratelimited = Обмеження швидкості
tui-goals-run-stopped = Зупинено
tui-goals-resume-from = { "  " }Відновиться з ітерації { $iteration } з { $max }
tui-goals-resume-from-simple = { "  " }Відновиться з ітерації { $iteration }
tui-goals-pause-explainer = Пауза зберігає цей поступ, зупинка його відкидає.
tui-goals-already-running = Ця ціль вже виконується — p ставить на паузу, x зупиняє.
tui-goals-already-paused = Ця ціль вже на паузі — s відновлює, x відкидає.
tui-goals-not-running = Призупинити можна лише ціль, що виконується.
tui-goals-nothing-to-stop = У цієї цілі немає запуску, який можна зупинити.
tui-goals-cadence = Ритм:
tui-goals-cadence-label = { "  " }Ритм:{ " " }
tui-goals-cadence-title = Ритм циклу
tui-goals-cadence-hint = Як часто агент робить наступний крок, у секундах. Порожнє поле означає типове значення { $default } с. Малий ритм витрачає токени швидше; максимум — { $max } с.
tui-goals-cadence-secs = { $secs } с
tui-goals-cadence-default = типове ({ $secs } с)
tui-goals-cadence-nav = Esc скасувати | Enter зберегти
tui-goals-cadence-not-a-number = Введіть ціле число секунд або залиште порожнім для типового значення.
tui-goals-cadence-out-of-range = Ритм має бути від { $min } до { $max } секунд.
tui-goals-new-title = Нова ціль
tui-goals-step = { "  " }крок { $n }/{ $total }
tui-goals-example = напр. "Виправити таймаут входу"
tui-goals-prompt = Що має виконати агент?
tui-goals-agent-hint = UUID або порожньо для автозапуску
tui-goals-verify-hint = Пробіл/Tab — перевіряльник контролює якість кожної ітерації
tui-goals-reviewer-hint = UUID або порожньо для автозапуску рецензента
tui-goals-judge = Суддя цілі:
tui-goals-model-hint = Модель для перевірки виконання, напр. "claude-haiku" (необов'язково)
tui-goals-review-on = ▣ Автоперевірка увімкнена (рецензент перевіряє кожну ітерацію)
tui-goals-review-off = ▢ Автоперевірку вимкнено
tui-goals-nav-submit = Esc назад | Enter надіслати
tui-goals-nav-toggle = Esc назад | Пробіл/Tab перемкнути | Enter далі
tui-goals-nav-next = Esc назад | Enter далі
...
cmd-goal-start-error = Помилка запуску цілі: { $error }
cmd-goal-watching = Спостереження за ціллю (Ctrl+C для зупинки)...
cmd-goal-progress =   [{ $current }/{ $total }] фаза={ $phase } прогрес={ $progress }%
cmd-goal-finished =   Ціль успішно завершено!
cmd-goal-max-iterations =   Ціль досягла максимуму ітерацій.
cmd-goal-rate-limited =   Запуск цілі обмежено лімітом.
cmd-goal-stopped =   Запуск цілі зупинено.
cmd-goal-error =   помилка: { $error }

tui-agents-detail-routing =   Маршрутизація:
tui-agents-hints-input-prompt =     [Enter] Далі  [Tab] Перегляд бібліотеки промптів  [Esc] Назад
tui-agents-hints-prompt-picker =   [↑↓] Навігація  [Enter] Вибрати промпт  [Esc] Назад
tui-agents-hints-routing-fixed =   [Space] Увімкнути гнучкий режим  [Enter] Створити  [Esc] Назад
tui-agents-hints-routing-flexible =   [↑↓] Навігація профілями  [Tab] Перемкнути профіль  [Space] Перемкнути режим  [h/l] Бюджет  [Enter] Створити  [Esc] Назад
tui-agents-label-no-prompts = (немає доступних промптів)
tui-agents-prompt-routing =   Конфігурація маршрутизації моделей:
tui-agents-prompt-select-prompt =   Виберіть промпт з бібліотеки:
