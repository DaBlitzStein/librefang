...
def main():
    ...
    expect(
        ...
        == {"post_agent_template_toml": "text/plain", "put_agent_template_toml": "text/plain", "put_document": "application/octet-stream", "transcribe_audio": "audio/webm", "upload_agent_avatar": "application/octet-stream", "upload_file": "application/octet-stream", "upload_user_avatar": "application/octet-stream"},
