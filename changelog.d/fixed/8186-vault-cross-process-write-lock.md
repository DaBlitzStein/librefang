...
Rotation was the worst of the three to lose a write to, because afterwards the old key no longer opens the file and the dropped entry cannot be read back by retrying with it. (#8284) (@DaBlitzStein)
